...
function get_divisions(standard_id) {
	$.ajax({
		...
		url: base_url+'academic_fees/get_class_divisions',
		method: $("#add_staff_form").attr('method'),
		dataType: 'json',
        success: function(response)
        {
            $('#division_id').html(response.division_html);
            
            $('#total_fees').val(response.standard_fees);
        }
	});
}
...
function get_applicable_students() {
	...
	$.ajax({
		...
		url: base_url+'academic_fees/get_applicable_students',
		method: $("#add_staff_form").attr('method'),
        success: function(response)
        {
