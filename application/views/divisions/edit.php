					...
					<div class="portlet-title">
						<div class="caption font-dark">
							<i class="icon-settings font-dark"></i> <span
								class="caption-subject bold uppercase"> Edit Division</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
		              ...
		              <?php }?>
						<form id="update_staff_form" class="horizontal-form"
							action="<?php echo base_url('divisions/update/'.$divisions_data['division_id']);?>" method="post">
							<div class="form-body">
								<h3 class="form-section">Edit Division Details</h3>
								<div class="row">
									<div class="col-md-6">
											...
											<label class="control-label">Standard</label> <select
												...
												<?php foreach ( $standards as $row ) { ?>
													...
													<?php echo set_select("standard_id",$row['standard_id'],
															$row['standard_id'] == $divisions_data['standard_id']?true:false);?>>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input id="division_name" name="division_name" class="form-control"
												type="text" value="<?php echo set_value('division_name',$divisions_data['division_name']);?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input id="intake" name="intake" class="form-control"
												type="text" value="<?php echo set_value('intake', $divisions_data['intake']);?>">
										</div>
									</div>
								</div>
