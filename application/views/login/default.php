...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url('login/checklogin');?>" method="post">
                ...
                <div class="form-actions">
                   ...
                   <a href="<?php echo base_url("login/forgot_password");?>" class="forget-password">Forgot Password?</a>
                </div>
