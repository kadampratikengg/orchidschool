				...
				<div class="portlet light ">
					<div class="portlet-title">
						<div class="caption font-dark">
							<i class="icon-settings font-dark"></i> <span
								class="caption-subject bold uppercase"> Update My Profile</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
		              ...
		              <?php }?>
						...
						<form id="update_student_profile" class="horizontal-form"
							action="<?php echo base_url('student_profile/update');?>" method="post">
							<div class="form-body">
