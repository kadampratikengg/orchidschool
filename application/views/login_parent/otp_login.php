    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form action="<?php echo base_url('login_parent/verify_otp');?>" method="post">
                <h3 class="font-green">OTP Verification</h3>
                ...
                <?php if(validation_errors()!=""){?>
		              ...
		              <?php }?>
                <p> Enter OTP sent on the entered mobile number</p>
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" 
                    name="otp" value="<?php echo set_value('otp');?>"/> </div>
                <div class="form-actions">
                    <a class="btn btn-default" href="<?php echo base_url("login_parent");?>">Back</a>
