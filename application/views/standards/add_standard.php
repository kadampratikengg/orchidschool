	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li><a href="<?php echo base_url('standards'); ?>">Standards</a> <i
					class="fa fa-angle-right"></i></li>
				<li><span>Add Standard</span></li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
			...
			<div class="col-md-12">
				...
				<div class="portlet light ">
					<div class="portlet-title">
						<div class="caption font-dark">
							<i class="icon-settings font-dark"></i> <span
								class="caption-subject bold uppercase"> Add Standard</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
		              ...
		              <?php }?>
						<form id="add_standards_form" class="horizontal-form"
							action="<?php echo base_url('standards/save_standard');?>" method="post">
							<div class="form-body">
								<h3 class="form-section">Standards Details</h3>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">Standard</label> <input
												id="standard_name" name="standard_name" class="form-control"
												type="text" value="<?php echo set_value('standard_name');?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">Standard Prefix</label> <select
												...
												<?php for($prefix = 'A'; $prefix < 'Z'; $prefix++) {	?>
													...
													<?php echo set_select('standard_prefix',$prefix);?>>
														<?php echo $prefix;?>
								                    </option>
											    <?php } ?>
											</select>
								...
								<input type="hidden" id="is_add" name="is_add" value="">
									<button id="save" type="submit" class="btn green-meadow" >
										<i class="fa fa-check"></i> Save
									</button>
									<button id="save_and_add" type="submit" class="btn yellow-gold" >
										<i class="fa fa-check"></i> Save & Add Instalments
									</button>
									<a href="<?php echo base_url('standards')?>"
