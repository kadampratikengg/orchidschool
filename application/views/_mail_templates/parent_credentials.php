									...
									<tbody>
											...
											<td style="padding: 30px" valign="top">
												<h4
													...
													<a href="javascript:;"
														...
														<?php echo get_config_value("website_name"); ?> Login Credentials</a>
												</h4>
											</td>
										</tr>
										...
										<tr>
											<td valign="top"><div
													...
													Hello <?php echo $parent_name; ?>,

													<p>
														Your login credentials for <?php echo get_config_value("website_name")?> are: <br /> <br />
														Login url: <?php echo base_url(); ?><br/>
