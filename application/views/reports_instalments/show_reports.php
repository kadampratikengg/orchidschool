...
<div class="page-content-wrapper">
	...
	<div class="page-content">
		<h3 class="page-title">Instalment Wise Reports</h3>
		<div class="page-bar">
					...
					<div class="portlet-title">
						<div class="caption font-dark">
							<i class="icon-reports font-dark"></i> <span
								class="caption-subject bold uppercase">Instalment Wise Report - 
								 <span class="text-muted"><?php echo $instalments_data['instalment_name'];?> Instalment</span></span>
						</div>
						<div class="actions">
							<a href="<?php base_url('reports_instalments');?>" class="btn btn-circle default"> Back</a>
						</div>
					</div>
						...
						<table	class="table table-striped table-bordered table-hover">
							...
							<tbody>
						            ...
						            foreach ( $reports_data as $row ) { ?>
										<tr class="odd gradeX">
									<td><?php echo $i; $i++;?></td>
									<td><a href="javascrpt:;" onclick="show_receivable()">	<?php echo $row["standard_name"]; ?> </a></td>
									
									<td><a href="javascrpt:;" onclick="show_receivable()">	Rs. <?php echo $row["invoice_amount"]; ?> </a></td>
...
<script>
	var standard_id = "<?php echo $instalments_data['standard_id']; ?>"
