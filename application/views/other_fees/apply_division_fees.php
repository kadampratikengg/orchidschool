	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li><a href="<?php echo base_url('academic_fees'); ?>">Other Fees</a>
					...
					<div class="portlet-title">
						<div class="caption font-dark">
							<i class="icon-settings font-dark"></i> <span
								class="caption-subject bold uppercase"> Apply Other Fees to Division</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
		              ...
		              <?php }?>
						<form id="apply_fees_form" class="horizontal-form"
							action="<?php echo base_url('other_fees/save_division_fees');?>" method="post">
							
							<input type="hidden" name="compulsory" id="compulsory" value="YES">
							<div class="form-body">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input id="description" name="description" class="form-control"
												type="text" value="<?php echo set_value('description');?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
